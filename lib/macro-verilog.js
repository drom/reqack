...
const eb = {
  ctrl: p =>
    (p.capacity === 1) ? eb1.ctrl(p) : (p.capacity === 1.5) ? eb15.ctrl(p) : (p.capacity === 1.7) ? eb17.ctrl(p) : (p.capacity >= 2) ? ebfifo.ctrl(p) : eb0.ctrl(p),
  data: p =>
    (p.capacity === 1) ? eb1.data(p) : (p.capacity === 1.5) ? eb15.data(p) : (p.capacity === 1.7) ? eb17.data(p) : (p.capacity >= 2) ? ebfifo.data(p) : eb0.data(p),
  ctrl2data: p =>
    (p.capacity === 1) ? eb1.ctrl2data(p) : (p.capacity === 1.5) ? eb15.ctrl2data(p) : (p.capacity === 1.7) ? eb17.ctrl2data(p) : (p.capacity >= 2) ? ebfifo.ctrl2data(p) : eb0.ctrl2data(p)
};
